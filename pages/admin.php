            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="store.php"><span class="pull-left" >IT Store</span>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="fixissue.php"><span class="pull-left">Fix Issues</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="Allocate.php"><span class="pull-left">Allocate/Reallocate Requests</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="move_admin.php"><span class="pull-left">Movement Request</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="move_admin.php"><span class="pull-left">Warranty Alarm</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <a href="move_admin.php"><span class="pull-left">Reallocation Alarm</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
